 ...
 */
 ...
 void print_header(const struct pictdb_header header) {
     ...
     /* Correcteur : pas d'utilisation des constantes RES_SMALL et RES_THUMBNAIL -1pt
      */
...
print_metadata (const struct pict_metadata metadata)
{
    ...
    /* Correcteur : pas d'utilisation des constantes RES_SMALL et RES_THUMBNAIL dans les indices
     * de tableau. -1pt
     */
