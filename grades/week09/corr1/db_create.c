              ...
              uint16_t small_res_X, uint16_t small_res_Y)
{
    ...
    //correcteur: vous pourriez faire ca dans le do_create_cmd, cela vous eviterez de passer une grande quantité d'argument à cette fonction
    ...
    //correcteur: vous ne devriez pas appeller do_close ici
    do_close(db_file);
