...
int main (int argc, char* argv[])
{
    ...
    //correcteur: il aurait fallu faire tout ca dans une fonction séparée pour l'interpréteur, par exemple a cause de ca on peut maintenant faire ./pictDBM quit, qui ne fera rien mais ca n'a pas de sens (et c'était dans l'énoncé)
